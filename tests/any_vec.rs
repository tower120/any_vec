...
fn remove_test() {
    ...
    assert_equal(
        any_vec.downcast_ref::<String>().unwrap().as_slice(),
        &[String::from("0"), String::from("1"), String::from("3")],
    );
...
fn swap_remove_test() {
    ...
    assert_equal(
        any_vec.downcast_ref::<String>().unwrap().as_slice(),
        &[String::from("0"), String::from("4"), String::from("3")],
    );

    any_vec.swap_remove(2);
    assert_equal(
        any_vec.downcast_ref::<String>().unwrap().as_slice(),
        &[String::from("0"), String::from("4")],
    );
}
...
fn any_vec_drain_in_the_middle_test() {
    ...
    assert_equal(
        any_vec.downcast_ref::<String>().unwrap().as_slice(),
        &[String::from("0"), String::from("3"), String::from("4")],
    );
}
...
fn mem_stack_test() {
    ...
    assert_equal(
        any_vec.downcast_ref::<String>().unwrap(),
        &[
            String::from("0"),
            String::from("1"),
            String::from("2"),
...
fn any_vec_debug() {
    ...
    assert_eq!(
        format!("{any_vec:?}"),
        format!("AnyVec {{ typeid: {typeid:?}, len: 0 }}")
    );
}
