...
unsafe impl<'a, Traits: ?Sized + Sync + Trait, M: Mem> Sync for Drain<'a, AnyVecPtr<Traits, M>>{}
#[allow(suspicious_auto_trait_impls)]
unsafe impl<'a, Type: Sync, M: Mem> Sync for Drain<'a, AnyVecRawPtr<Type, M>>{}

#[allow(suspicious_auto_trait_impls)]
unsafe impl<'a, Traits: ?Sized + Send + Trait, M: Mem> Send for Drain<'a, AnyVecPtr<Traits, M>>{}
#[allow(suspicious_auto_trait_impls)]
unsafe impl<'a, Type: Send, M: Mem> Send for Drain<'a, AnyVecRawPtr<Type, M>>{}